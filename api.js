  ...
  ajaxModule.prototype = {
    ...
    callAjax: function(request, callback) {
      ...
      var ajaxRequest = $.ajax({
        url: "https://pixabay.com/api/?username=mjweaver01&key=20389652-37eb274614f11fbe81ee18bbe&q=" + request + "&image_type=all &per_page=6 ",
    ...
    parseResponse: function(response) {
      ...
      $.each(response.hits, function(index, value) {
        $(".wrapper").prepend("<div class='image image" + index + "' style='width:" + 400 + "px; height:" + 350 + "px;  background: url(" + value.webformatURL + ");'><a href='" + value.pageURL + "' target='_blank'><div class='overlay'></div></a><div class='hidden'></div></div>");
